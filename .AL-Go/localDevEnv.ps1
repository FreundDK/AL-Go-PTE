...
$webClient.DownloadFile('https://raw.githubusercontent.com/FreundDK/AL-Go-Actions/mychanges/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/FreundDK/AL-Go-Actions/mychanges/AL-Go-Helper.ps1', $ALGoHelperPath)
